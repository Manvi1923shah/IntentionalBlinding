...
expName = 'ISB'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\urmil\\OneDrive\\Desktop\\ISB_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text='report the dealy between the key press ad the beep sound (0-999); click submit after entering the value ',
    font='Open Sans',
...
trials = data.TrialHandler(nReps=9.0, method='random', 
    ...
    trialList=data.importConditions('intentionalBlinding_task.xlsx'),
